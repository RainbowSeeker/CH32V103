...
#define SPI_SCK_PIN     SPI1_SCK_PA5     //接模块SPC
#define SPI_MOSI_PIN    SPI1_MOSI_PA7    //接模块SDI
#define SPI_MISO_PIN    SPI1_MISO_PA6    //接模块SDO
#define SPI_CS_PIN      B10               //接模块CS

...
void UserI2c_Init(void)
{
    ...
    gpio_init(B1,GPO,1,GPIO_PIN_CONFIG);
	i2caddr=I2CDEVID;
    uint8 dirt_send_flag=1;
    UserI2c_WritenByte((unsigned char *)&dirt_send_flag, 0x09, 1);
    delay_ms(100);
    uint8 dirt_detection_flag=0;
    UserI2c_WritenByte((unsigned char *)&dirt_detection_flag, 0x08, 1);
    delay_ms(100);
}
/*******************************************************************************

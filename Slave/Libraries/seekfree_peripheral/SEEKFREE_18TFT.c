...
{
#ifdef SimIIC
    gpio_init(TFT_SCL_PIN,GPO,0,GPIO_PIN_CONFIG);
    gpio_init(TFT_SDA_PIN,GPO,0,GPIO_PIN_CONFIG);
#else
    spi_init(TFT_SPIN, TFT_SCL_PIN, TFT_SDA_PIN, TFT_SDA_IN, TFT_CS_PIN, 0, FPCLK_DIV_2);//硬件SPI初始化
#endif
